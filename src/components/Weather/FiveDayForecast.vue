...
const dailyForecast = computed(() => {
    ...
    //Average out data for each day and return it
    ...
    <div class="m-2 block border border-gray-200 rounded-lg bg-sky-600 flex flex-col">
        ...
        <div class="font-bold">
            <div class="flex flex-col text-white justify-center">
                <div v-for="(forecast, idx) in dailyForecast" :key="forecast.date.toISOString()"
                    class="inline-block border-b border-gray-200 last:border-b-0" :class="{
                        'pl-1': idx === 0,
